...
test('location: set', () => {
  ...
  expect(location.pathname).toBe('/p/a/t/h');
  global.expectPagePath = `/pages/home/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/?query=string#hash'
  )}&search=${encodeURIComponent('?query=string')}&hash=${encodeURIComponent('#hash')}`;
  location.pathname = '';
  expect(location.pathname).toBe('/');
  ...
  expect(tempType).toBe('jump');
  global.expectPagePath = `/pages/list/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/list/123?query=string#hash'
  )}&search=${encodeURIComponent('?query=string')}&hash=${encodeURIComponent('#hash')}`;
  ...
  expect(location.search).toBe('?query=string');
  global.expectPagePath = `/pages/list/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/list/123#hash'
  )}&hash=${encodeURIComponent('#hash')}`;
  location.search = '';
  expect(location.search).toBe('');
  global.expectPagePath = `/pages/list/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/list/123?a=123#hash'
  )}&search=${encodeURIComponent('?a=123')}&hash=${encodeURIComponent('#hash')}`;
  ...
  expect(location.search).toBe('');
  global.expectPagePath = `/pages/list/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/list/123?c=321#hash'
  )}&search=${encodeURIComponent('?c=321')}&hash=${encodeURIComponent('#hash')}`;
  ...
  global.expectPagePath = `/pages/list/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/list/123?c=321'
  )}&search=${encodeURIComponent('?c=321')}`;
  location.hash = '';
  expect(location.hash).toBe('');
  ...
  tempURL = location.href;
  global.expectPagePath = `/pages/list/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/list/123?c=321#abc'
  )}&search=${encodeURIComponent('?c=321')}&hash=${encodeURIComponent('#abc')}`;
  location.hash = 'abc';
  ...
  tempURL = location.href;
  global.expectPagePath = `/pages/list/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/list/123?c=321#cba'
  )}&search=${encodeURIComponent('?c=321')}&hash=${encodeURIComponent('#cba')}`;
  location.hash = '#cba';
  ...
  expect(hashChangeCount).toBe(4);
  global.expectPagePath = `/pages/list/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/list/c.b.a?p=456#000'
  )}&search=${encodeURIComponent('?p=456')}&hash=${encodeURIComponent('#000')}`;
  ...
  expect(tempType).toBe('jump');
  tempURL = location.href;
  global.expectPagePath = `/pages/detail/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/detail/haha?n=098#000'
  )}&search=${encodeURIComponent('?n=098')}&hash=${encodeURIComponent('#000')}`;
  ...
  global.expectPagePath = `/pages/home/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/p/a/t/h?query=string#hash'
  )}&search=${encodeURIComponent('?query=string')}&hash=${encodeURIComponent('#hash')}`;
  global.expectWxCallMethod = 'redirectTo';
  location.reload();
  expect(location.href).toBe('https://test.miniprogram.com/p/a/t/h?query=string#hash');
  ...
  // replace
  global.expectPagePath = `/pages/detail/index?type=jump&targeturl=${encodeURIComponent(
    'https://test.miniprogram.com/index/aaa/detail/123?query=string#hash'
  )}&search=${encodeURIComponent('?query=string')}&hash=${encodeURIComponent('#hash')}`;
  global.expectWxCallMethod = 'redirectTo';

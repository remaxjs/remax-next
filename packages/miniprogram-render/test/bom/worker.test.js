...
test('worker', () => {
  ...
  expect(evt1.data).toEqual({
    ...
    to: 'test',
    count: 1,
    receive: { type: 'message', data: { from: 'test', to: 'worker' } },
  });
  ...
  expect(evt1.data).toEqual({
    ...
    to: 'test2',
    count: 2,
    receive: { type: 'message', data: { from: 'test2', to: 'worker' } },
  });
  expect(evt2.data).toEqual(evt1.data);
  ...
  expect(evt1.data).toEqual({
    ...
    to: 'test3',
    count: 3,
    receive: { type: 'message', data: { from: 'test3', to: 'worker' } },
  });
  ...
  expect(evt1.data).toEqual({
    ...
    to: 'test',
    count: 1,
    receive: { type: 'message', data: { from: 'test', to: 'sharedWorker' } },
  });
  expect(evt2.data).toEqual(evt1.data);
  ...
  expect(evt1.data).toEqual({
    ...
    to: 'test2',
    count: 2,
    receive: { type: 'message', data: { from: 'test2', to: 'sharedWorker' } },
  });
  expect(evt2.data).toEqual(evt1.data);
  ...
  expect(evt1.data).toEqual({
    ...
    to: 'test3',
    count: 3,
    receive: { type: 'message', data: { from: 'test3', to: 'sharedWorker' } },
  });
  expect(evt2.data).toEqual({
    from: 'sharedWorker',
    to: 'test2',
  ...
  expect(evt3.data).toEqual({
    ...
    to: 'test4',
    count: 4,
    receive: { type: 'message', data: { from: 'test4', to: 'sharedWorker' } },
  });
  ...
  expect(evt1.data).toEqual({
    navigator: {
      ...
      product: 'Gecko',
      userAgent:
        'Mozilla/5.0 (Windows NT 6.1; win64; x64) AppleWebKit/602.3.12 (KHTML, like Gecko) Mobile MicroMessenger/7.0.0 Language/zh',
    },
    location: {
      hash: '',
      host: '',

...
test('element: innerHTML/outerHTML', () => {
  ...
  expect(node1.innerHTML).toBe(
    '<span id="abc"></span><div id="cc" class="a b c" style="position:absolute;top:10px;left:20px;">123<span id="cba">555</span>321</div><br />'
  );
  expect(node1.outerHTML).toBe(
    '<article id="outer"><span id="abc"></span><div id="cc" class="a b c" style="position:absolute;top:10px;left:20px;">123<span id="cba">555</span>321</div><br /></article>'
  );
  ...
  node1.innerHTML =
    '<div id="a">321<span id="inner" b="inner">765</span>123</div><div id="c">555</div><p style="color: green; text-align: center;">I am content</p>';
  ...
  node1.outerHTML =
    '<header id="outer2"><div id="a">321<span id="inner" b="inner">765</span>123</div><div id="c">555</div><p style="color: green; text-align: center;">I am content</p></header>';
...
test('element: dataset', () => {
  ...
  expect(node1.innerHTML).toEqual(
    '<div data-a="abc" data-bc-d-efg="hij" data-hi-j="123" data-k-lm-n-op-qr="klm"></div>'
  );
  ...
  expect(node3.outerHTML).toEqual(
    '<div data-a="abc" data-bc-d-efg="hij" data-hi-j="321" data-k-lm-n-op-qr="klm"></div>'
  );
...
test('element: cloneNode', () => {
  ...
  expect(node8.childNodes[0].childNodes[0].childNodes[0].textContent).toBe(
    node1.childNodes[0].childNodes[0].childNodes[0].textContent
  );

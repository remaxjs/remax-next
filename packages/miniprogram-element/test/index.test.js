...
test('render', async () => {
  ...
  await _.sleep(10);
  expect(_.getSimpleHTML(component.dom.innerHTML)).toBe(
    _.getSimpleHTML(`<element class="h5-body" style="width: 100%; height: 100%;" data-private-node-id="e-body" data-private-page-id="${page.pageId}">
  ...
  await _.sleep(10);
  expect(_.getSimpleHTML(component2.dom.innerHTML)).toBe(
    _.getSimpleHTML(`<element class="h5-body" style="width: 100%; height: 100%;" data-private-node-id="e-body" data-private-page-id="${page.pageId}">

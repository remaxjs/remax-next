  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        ...
        {
          from: path.resolve(__dirname, '../src/custom-component'),
          to: path.resolve(__dirname, '../dist/custom-component'),
        },
        ...
        {
          from: path.resolve(__dirname, '../src/index-vhost.js'),
          to: path.resolve(__dirname, '../dist/index-vhost.js'),
        },
        {
          from: path.resolve(__dirname, '../src/index-vhost.json'),
          to: path.resolve(__dirname, '../dist/index-vhost.json'),
        },
        {
          from: path.resolve(__dirname, '../src/index-vhost.wxml'),
          to: path.resolve(__dirname, '../dist/index-vhost.wxml'),
        },
        {
          from: path.resolve(__dirname, '../src/index-vhost.wxss'),
          to: path.resolve(__dirname, '../dist/index-vhost.wxss'),
        },
      ],
    }),
  ],
